...
public class MainActivity extends BaseActivity implements OnTabSelectListener
    ...
    protected void onResume() {
        ...
        if (UserConfig.isLogin()) {
            mLoginRealtiveLayout.setVisibility(View.VISIBLE);
            mNoLoginView.setVisibility(View.GONE);
            mUser = TourApplation.getInstance().getActiveUser();
            Glide.with(this)
                    .load(mUser.headerImgUrl)
                    ...
                    .into(mUserIcon);
            mUserName.setText(mUser.nick);
            mUserSignTextView.setText(mUser.userSummary);
        } else {
            mLoginRealtiveLayout.setVisibility(View.GONE);
    ...
    private void initDrawerLayout() {
        ...
        mUserName = mDrawerLayoutView.findViewById(R.id.text_main_user_name);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.circle_image_user_icon:
            case R.id.text_main_user_name:
            case R.id.text_main_user_sign:
                if (UserConfig.isLogin()){
