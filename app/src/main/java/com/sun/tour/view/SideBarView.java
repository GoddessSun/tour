...
public class SideBarView extends View{
    ...
    private void init(Context context, AttributeSet attrs) {
        mLetters = Arrays.asList(context.getResources().getStringArray(R.array.Sidebar));
        ...
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen.title_small_txt_size);
        mLargeTextSize = context.getResources().getDimensionPixelSize(R.dimen.title_small_txt_size);
        mPadding = context.getResources().getDimensionPixelSize(R.dimen.dimen10);
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SideBarView);
            ...
            mRadius = a.getInt(R.styleable.SideBarView_sidebarRadius, context.getResources().getDimensionPixelSize(R.dimen.title_small_txt_size));
            mBallRadius = a.getInt(R.styleable.SideBarView_sidebarBallRadius, context.getResources().getDimensionPixelSize(R.dimen.dimen16));
            a.recycle();
        }
